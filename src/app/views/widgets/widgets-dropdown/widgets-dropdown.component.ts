...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  //Function d'affichage du nombre de user getProjetCount

  private getCount() {
    this.countService
      .getUserCount(this.currentUser.data.Idcommune)
      .subscribe((data) => {
        this.userCount = data;
      });
  }

  //Function d'affichage du nombre de projet

  private getProjet() {
    this.countService.getProjetCount().subscribe((data) => {
      this.projetCount = data;
    });
  }

  //Function d'affichage du nombre d'informations

  private getInfos() {
    this.countService
      .getInfosCount(this.currentUser.data.Idcommune)
      .subscribe((response) => {
        this.infosCount = response;
      });
  }
}
